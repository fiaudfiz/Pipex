...
#    Updated: 2026/02/14 11:03:04 by miouali          ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRCS_PIPEX = main.c handle_error.c utils.c second_son.c handle_error_bonus.c
SRCS_BONUS_PIPEX = main_bonus.c handle_error.c utils.c handle_error_bonus.c
